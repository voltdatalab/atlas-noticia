...
<a href="{{ site.baseurl }}/graficos/atlas_report_english_v2.pdf" class="btn btn--dark btn--rounded btn--w-icon btn--w-icon-left">Full report in English (PDF)</a>
...
![Chart 1 - per media]({{ site.baseurl }}/graficos/english/chart1.png)
...
![Chart 2 - main map]({{ site.baseurl }}/graficos/english/map1.png)

![Chart 3 - main map]({{ site.baseurl }}/graficos/english/map2.png)
...
![Chart 4 - main map]({{ site.baseurl }}/graficos/english/map3.png)

![Chart 5 - main map]({{ site.baseurl }}/graficos/english/map4.png)
